...
interface ForecastProfitabilitySummary {
...
export default function ForecastPage() {
  ...
  const [profitability, setProfitability] = useState<ForecastProfitabilitySummary>({
    actualRevenue: 0,
    actualCost: 0,
    actualProfit: 0,
    actualMargin: 0,
    ...
    const fetchForecast = async () => {
      ...
      try {
        const result = await apiFetch<{
          ...
          profitability: ForecastProfitabilitySummary
    ...
    >
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <ProfitabilitySummary
          revenue={profitability.actualRevenue}
          cost={profitability.actualCost}
          profit={profitability.actualProfit}
          margin={profitability.actualMargin}
          description="Historical profitability for the recent forecast window"
        />
        <ProfitabilitySummary
          revenue={profitability.forecastRevenue}
          cost={profitability.forecastCost}
          profit={profitability.forecastProfit}
          margin={profitability.forecastMargin}
          description="Forecasted profitability for the upcoming period"
        />
      </div>
