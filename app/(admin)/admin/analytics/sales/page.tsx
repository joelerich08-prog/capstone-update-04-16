...
export default function SalesAnalyticsPage() {
  ...
  const [paymentData, setPaymentData] = useState<PaymentDataPoint[]>([
    { type: 'Cash', total: 0, count: 0, profit: 0 },
    { type: 'GCash', total: 0, count: 0, profit: 0 },
    { type: 'Maya', total: 0, count: 0, profit: 0 },
  ])
  ...
  const handleExportReport = () => {
    ...
    const rows: Array<Array<string | number>> = [
      ...
      ['Summary', 'Gross Profit', formatCurrency(totalProfit), `Profit margin ${profitMargin.toFixed(1)}%`],
      ['Summary', 'Total Cost', formatCurrency(totalCost), 'Total cost of sold inventory'],
    ...
    paymentData.forEach(payment => {
      ...
      rows.push([
        ...
        `${payment.count} transactions, ${revenuePercent}% of revenue, ${countPercent}% of transactions, Profit ${formatCurrency(payment.profit)}`,
      ])
    })
  ...
  return (
    ...
    >
      ...
      <ProfitabilitySummary
        ...
        profit={totalProfit}
        margin={profitMargin}
        description="Core profitability metrics for the selected sales period"
      />
          ...
          <CardContent>
            ...
            <div className="mt-4 space-y-2">
              {paymentData.map((payment, index) => (
                <div key={payment.type} className="flex flex-col gap-1 rounded-lg border p-3">
                  ...
                  <div className="flex items-center justify-between text-xs text-muted-foreground">
                    ...
                    <span>{formatCurrency(payment.profit)} profit</span>
                  </div>
                </div>
              ))}
            </div>
